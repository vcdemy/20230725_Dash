...
app.layout = html.Div([
    ...
    html.Hr(),
    html.Div([
        html.Div(dcc.Dropdown(options=stocks, value='TSLA', id='controls-and-radio-item'), style={'width': '19%', 'display': 'inline-block'}),
        html.Div(dcc.Slider(10, 100, 10, value=50, id="my-slider"), style={'width': '79%', 'display': 'inline-block'}),
    ]),
    html.Hr(),
